...
class CustomValidator : public BaseValidator
{
public:
  CustomValidator(ShoppingTrx& trx, FosBaseGenerator& generator, FosStatistic& stats)
    : BaseValidator(trx, generator, stats)
  {
  }

  virtual ValidatorType getType() const override { return VALIDATOR_CUSTOM; }
