...
class SnowmanValidator : public BaseValidator
{
public:
  SnowmanValidator(ShoppingTrx& trx, FosBaseGenerator& generator, FosStatistic& stats)
    : BaseValidator(trx, generator, stats)
  {
  }

  virtual ValidatorType getType() const override { return VALIDATOR_SNOWMAN; }
