...
class DiamondValidator : public BaseValidator
{
public:
  DiamondValidator(ShoppingTrx& trx, FosBaseGenerator& generator, FosStatistic& stats)
    : BaseValidator(trx, generator, stats)
  {
  }

  virtual ValidatorType getType() const override { return VALIDATOR_DIAMOND; }
