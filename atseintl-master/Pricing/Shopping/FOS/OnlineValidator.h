...
class OnlineValidator : public BaseValidator
{
public:
  OnlineValidator(ShoppingTrx& trx, FosBaseGenerator& generator, FosStatistic& stats)
    : BaseValidator(trx, generator, stats)
  {
  }

  virtual ValidatorType getType() const override { return VALIDATOR_ONLINE; }
