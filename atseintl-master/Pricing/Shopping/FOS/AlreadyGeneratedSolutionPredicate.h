...
class AlreadyGeneratedSolutionPredicate : public tse::utils::IPredicate<SopCombination>
{
public:
  explicit AlreadyGeneratedSolutionPredicate(const ShoppingTrx& trx) : _trx(trx) {}
