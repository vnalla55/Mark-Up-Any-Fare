//-------------------------------------------------------------------
//
//  File:DSSResponseContentHandler.h
//
...
class DSSResponseContentHandler : public xercesc::DefaultHandler
{
public:
  //--------------------------------------------------------------------------
  // @function DSSResponseContentHandler::DSSResponseContentHandler
  //
  // Description: constructor
  //
  // @param textHolder - where to put rule text
  //--------------------------------------------------------------------------
  DSSResponseContentHandler(const FareDisplayTrx& trx, std::vector<FlightCount*>& flightCounts)
    : _trx(trx), _flightCounts(flightCounts)
  {
  }

  virtual ~DSSResponseContentHandler() = default;

  const bool initialize();

  //--------------------------------------------------------------------------
  // @function DSSResponseContentHandler::parse
  //
...
private:
  ...
  std::vector<FlightCount*>& _flightCounts;

  //--------------------------------------------------------------------------
  // @function DSSResponseContentHandler::startElement
  //
  ...
  void processFSDAtts(const xercesc::Attributes& attrs);

  void processPTMAtts(const xercesc::Attributes& attrs) {}

  //--------------------------------------------------------------------------
  // @function DSSResponseContentHandler::endElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function DSSResponseContentHandler::characters
  //
