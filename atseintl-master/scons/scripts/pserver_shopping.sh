...
${VALGHOME}/bin/valgrind -v --skin=calltree --simulate-cache=no --dump-threads=yes /vobs/atseintl/bin/debug/tseserver -D TO_MAN.IOR_FILE=$IOR -D SERVER_SOCKET_ADP.PORT=5500 -D TO_MAN.XFORM_NAME=CXS_XFORM $*
