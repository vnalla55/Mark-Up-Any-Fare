...
{
public:
  OptionalServicesSeg() : _segNo(0), _category(0), _ruleTariff(0) {}
  ...
  {
    return (_segNo == second._segNo) && (_category == second._category) &&
...
private:
  ...
  {
    return buffer & ptr->_segNo & ptr->_category & ptr->_ruleTariff & ptr->_rule;
  }
};
}
