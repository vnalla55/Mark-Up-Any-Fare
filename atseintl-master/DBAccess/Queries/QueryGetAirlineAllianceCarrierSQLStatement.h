...
class QueryGetAirlineAllianceCarrierSQLStatement : public DBAccess::SQLStatement
{
public:
  QueryGetAirlineAllianceCarrierSQLStatement() {};
  virtual ~QueryGetAirlineAllianceCarrierSQLStatement() {};

  enum ColumnIndexes
  {
    // AIRLINEALLIANCECARRIER:
    CARRIER = 0,
  ...
  static tse::AirlineAllianceCarrierInfo* mapRowToAirlineAllianceCarrierInfo(Row* row)
  {
...
///////////////////////////////////////////////////////////////////////
template <class QUERYCLASS>
class QueryGetAirlineAllianceCarrierHistoricalSQLStatement
    : public QueryGetAirlineAllianceCarrierSQLStatement<QUERYCLASS>
{
