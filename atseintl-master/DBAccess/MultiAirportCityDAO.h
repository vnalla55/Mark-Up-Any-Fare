...
public:
  ...
  {
    return DummyObjectInserter<MultiAirportCity, MultiAirportCityDAO>(flatKey, objectKey).success();
  }
...
protected:
  ...
  friend class DAOHelper<MultiAirportCityDAO>;
  static DAOHelper<MultiAirportCityDAO> _helper;
  MultiAirportCityDAO(int cacheSize = 0, const std::string& cacheType = "")
...
private:
  static MultiAirportCityDAO* _instance;
