// ----------------------------------------------------------------------------
// © 2009, Sabre Inc. All rights reserved. This software/documentation
...
#ifndef VOLUNTARY_REFUNDS_CONFIG_H
#define VOLUNTARY_REFUNDS_CONFIG_H
...
{
public:
  bool operator==(const VoluntaryRefundsConfig& rhs) const
  {
  ...
  static void dummyData(VoluntaryRefundsConfig& obj)
  {
    obj._carrier = "ABC";
