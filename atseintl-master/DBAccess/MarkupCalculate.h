...
#define MARKUP_CALCULATE_MEMBERS                                                                   \
  (_orderNo)(_tvlEffDate)(_tvlDiscDate)(_negFareCalcSeq)(_directionality)(_loc1)(_loc2)(           \
      _bundledInd)(_sellingFareInd)(_sellingPercentNoDec)(_sellingPercent)(_netSellingInd)(        \
      _sellingNoDec1)(_sellingFareAmt1)(_sellingCur1)(_sellingNoDec2)(_sellingFareAmt2)(           \
      _sellingCur2)(_percentMinNoDec)(_percentMin)(_percentMaxNoDec)(_percentMax)(_markupFareInd)( \
      _markupNoDec1)(_markupMinAmt1)(_markupMaxAmt1)(_markupCur1)(_markupNoDec2)(_markupMinAmt2)(  \
      _markupMaxAmt2)(_markupCur2)(_fareClass)(_fareType)(_seasonType)(_dowType)(                  \
      _wholesalerNoDec1)(_wholesalerFareAmt1)(_wholesalerCur1)(_wholesalerNoDec2)(                 \
      _wholesalerFareAmt2)(_wholesalerCur2)(_wholesalerFareInd)(_wholesalerPercentNoDec)(          \
      _wholesalerPercent)(_psgType)(_noSellInd)
...
public:
  ...
  {
    return (
        (_orderNo == rhs._orderNo) && (_tvlEffDate == rhs._tvlEffDate) &&
        (_tvlDiscDate == rhs._tvlDiscDate) && (_negFareCalcSeq == rhs._negFareCalcSeq) &&
        (_directionality == rhs._directionality) && (_loc1 == rhs._loc1) && (_loc2 == rhs._loc2) &&
        (_bundledInd == rhs._bundledInd) && (_sellingFareInd == rhs._sellingFareInd) &&
        (_sellingPercentNoDec == rhs._sellingPercentNoDec) &&
        (_sellingPercent == rhs._sellingPercent) && (_netSellingInd == rhs._netSellingInd) &&
        (_sellingNoDec1 == rhs._sellingNoDec1) && (_sellingFareAmt1 == rhs._sellingFareAmt1) &&
        (_sellingCur1 == rhs._sellingCur1) && (_sellingNoDec2 == rhs._sellingNoDec2) &&
        (_sellingFareAmt2 == rhs._sellingFareAmt2) && (_sellingCur2 == rhs._sellingCur2) &&
        (_percentMinNoDec == rhs._percentMinNoDec) && (_percentMin == rhs._percentMin) &&
        (_percentMaxNoDec == rhs._percentMaxNoDec) && (_percentMax == rhs._percentMax) &&
        (_markupFareInd == rhs._markupFareInd) && (_markupNoDec1 == rhs._markupNoDec1) &&
        (_markupMinAmt1 == rhs._markupMinAmt1) && (_markupMaxAmt1 == rhs._markupMaxAmt1) &&
        (_markupCur1 == rhs._markupCur1) && (_markupNoDec2 == rhs._markupNoDec2) &&
        (_markupMinAmt2 == rhs._markupMinAmt2) && (_markupMaxAmt2 == rhs._markupMaxAmt2) &&
        (_markupCur2 == rhs._markupCur2) && (_fareClass == rhs._fareClass) &&
        (_fareType == rhs._fareType) && (_seasonType == rhs._seasonType) &&
        (_dowType == rhs._dowType) && (_wholesalerNoDec1 == rhs._wholesalerNoDec1) &&
        (_wholesalerFareAmt1 == rhs._wholesalerFareAmt1) &&
        (_wholesalerCur1 == rhs._wholesalerCur1) && (_wholesalerNoDec2 == rhs._wholesalerNoDec2) &&
        ...
        (_wholesalerPercent == rhs._wholesalerPercent) && (_psgType == rhs._psgType) &&
        (_noSellInd == rhs._noSellInd));
  }

  static void dummyData(MarkupCalculate& obj)
  {
    obj._orderNo = 1;
    obj._tvlEffDate = time(nullptr);
    obj._tvlDiscDate = time(nullptr);
    obj._negFareCalcSeq = 2;
    ...
    obj._bundledInd = 'B';
    obj._sellingFareInd = 'C';
    obj._sellingPercentNoDec = 3;
    obj._sellingPercent = 4.444;
    obj._netSellingInd = 'D';
    obj._sellingNoDec1 = 5;
    obj._sellingFareAmt1 = 6.66;
    obj._sellingCur1 = "EFG";
    obj._sellingNoDec2 = 7;
    obj._sellingFareAmt2 = 8.88;
    obj._sellingCur2 = "HIJ";
    obj._percentMinNoDec = 9;
    obj._percentMin = 10.101;
    obj._percentMaxNoDec = 11;
    obj._percentMax = 12.121;
    obj._markupFareInd = 'K';
    obj._markupNoDec1 = 13;
    obj._markupMinAmt1 = 14.14;
    obj._markupMaxAmt1 = 15.15;
    obj._markupCur1 = "LMN";
    obj._markupNoDec2 = 16;
    obj._markupMinAmt2 = 17.17;
    obj._markupMaxAmt2 = 18.18;
    obj._markupCur2 = "OPQ";
    obj._fareClass = "RSTUVWXY";
    obj._fareType = "aaa";
    obj._seasonType = 'Z';
    obj._dowType = 'a';
    obj._wholesalerNoDec1 = 19;
    obj._wholesalerFareAmt1 = 20.20;
    obj._wholesalerCur1 = "bcd";
    obj._wholesalerNoDec2 = 21;
    obj._wholesalerFareAmt2 = 22.22;
    obj._wholesalerCur2 = "efg";
    obj._wholesalerFareInd = 'h';
    obj._wholesalerPercentNoDec = 23;
    obj._wholesalerPercent = 24.242;
    obj._psgType = "ijk";
    obj._noSellInd = 'l';
  }
...
private:
  ...
  {
    return buffer & ptr->_orderNo & ptr->_tvlEffDate & ptr->_tvlDiscDate & ptr->_negFareCalcSeq &
           ptr->_directionality & ptr->_loc1 & ptr->_loc2 & ptr->_bundledInd &
           ptr->_sellingFareInd & ptr->_sellingPercentNoDec & ptr->_sellingPercent &
           ptr->_netSellingInd & ptr->_sellingNoDec1 & ptr->_sellingFareAmt1 & ptr->_sellingCur1 &
           ptr->_sellingNoDec2 & ptr->_sellingFareAmt2 & ptr->_sellingCur2 & ptr->_percentMinNoDec &
           ptr->_percentMin & ptr->_percentMaxNoDec & ptr->_percentMax & ptr->_markupFareInd &
           ptr->_markupNoDec1 & ptr->_markupMinAmt1 & ptr->_markupMaxAmt1 & ptr->_markupCur1 &
           ptr->_markupNoDec2 & ptr->_markupMinAmt2 & ptr->_markupMaxAmt2 & ptr->_markupCur2 &
           ptr->_fareClass & ptr->_fareType & ptr->_seasonType & ptr->_dowType &
           ptr->_wholesalerNoDec1 & ptr->_wholesalerFareAmt1 & ptr->_wholesalerCur1 &
           ptr->_wholesalerNoDec2 & ptr->_wholesalerFareAmt2 & ptr->_wholesalerCur2 &
           ptr->_wholesalerFareInd & ptr->_wholesalerPercentNoDec & ptr->_wholesalerPercent &
           ptr->_psgType & ptr->_noSellInd;
  }
};
}
