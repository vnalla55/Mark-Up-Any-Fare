...
class RexFareSelectorDiscountedStrategy : public RexFareSelectorStrategy
{
  friend class RexFareSelectorDiscountedStrategyTest;

public:
  RexFareSelectorDiscountedStrategy(const RexBaseTrx& trx, PreSelectedFaresStore& store)
