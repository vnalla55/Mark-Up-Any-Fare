//----------------------------------------------------------------------------
//  File:           Category9.h
//  Description:    Category9 header file for ATSE International Project
//  Created:        6/29/2007
...
public:
  Category9();
  virtual ~Category9();
  static const std::string name() { return std::string("PASSENGER TYPE"); }
  //-----------------------------------------------------------------------------
  // Copy Constructor must be in Public for Pooled Objects
  //-----------------------------------------------------------------------------
  Category9(const Category9& item);
  Category9& operator=(const Category9& item);
...
protected:
private:
  void formatNumber(std::string& psgAge, uint16_t age);
