...
namespace tse
{
class TaxSP43Test : public CppUnit::TestFixture
{
  CPPUNIT_TEST_SUITE(TaxSP43Test);
  CPPUNIT_TEST(testConstructor);
  CPPUNIT_TEST(testTaxSP43);
  CPPUNIT_TEST_SUITE_END();

public:
  void testConstructor()
  {
    try { TaxSP43Test taxOrchestratorTest; }
    catch (...)
    {
  ...
  void testTaxSP43()
  {
    ...
    taxSP43.validateTransit(trx, taxResponse, taxCodeReg, travelSegIndex);
...
CPPUNIT_TEST_SUITE_REGISTRATION(TaxSP43Test);
}
