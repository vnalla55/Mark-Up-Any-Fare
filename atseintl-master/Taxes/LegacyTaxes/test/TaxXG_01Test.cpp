...
class TaxXG_01m : public TaxXG_01
{
public:
...
class TaxXG_01Test : public CppUnit::TestFixture
{
  CPPUNIT_TEST_SUITE(TaxXG_01Test);
...
CPPUNIT_TEST_SUITE_REGISTRATION(TaxXG_01Test);
};
