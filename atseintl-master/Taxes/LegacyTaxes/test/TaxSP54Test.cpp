...
namespace tse
{
class TaxSP54Test : public CppUnit::TestFixture
{
  CPPUNIT_TEST_SUITE(TaxSP54Test);
  CPPUNIT_TEST(testConstructor);
  CPPUNIT_TEST(testTaxSP54);
  CPPUNIT_TEST_SUITE_END();

public:
  void testConstructor()
  {
    try { TaxSP54Test taxOrchestratorTest; }
    catch (...)
    {
  ...
  void testTaxSP54()
  {
    ...
    taxSP54.validateTransit(trx, taxResponse, taxCodeReg, travelSegIndex);
...
CPPUNIT_TEST_SUITE_REGISTRATION(TaxSP54Test);
}
