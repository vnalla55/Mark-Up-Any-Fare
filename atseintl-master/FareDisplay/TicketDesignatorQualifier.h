//----------------------------------------------------------------------------
//
//  File:           TicketDesignatorQualifier.h
//
...
class TicketDesignatorQualifier : public Qualifier
{
public:
  TicketDesignatorQualifier();
  virtual ~TicketDesignatorQualifier();
...
private:
  bool _removeTicketDesignatorCheck;
};
} // namespace tse
