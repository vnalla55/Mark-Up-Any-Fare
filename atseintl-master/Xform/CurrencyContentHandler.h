...
class CurrencyContentHandler : public xercesc::DefaultHandler
{
public:
  explicit CurrencyContentHandler(DataModelMap& dataModelMap) : _dataModelMap(dataModelMap) {}

  virtual ~CurrencyContentHandler() = default;

  //--------------------------------------------------------------------------
  // @function CurrencyContentHandler::parse
  //
...
private:
  ...
  //--------------------------------------------------------------------------
  // @function CurrencyContentHandler::startElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function CurrencyContentHandler::endElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function CurrencyContentHandler::characters
  //
