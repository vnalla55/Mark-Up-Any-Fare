//-------------------------------------------------------------------
//
//  File:        PricingDisplayContentHandler.h
...
class PricingDisplayContentHandler : public xercesc::DefaultHandler
{
public:
  PricingDisplayContentHandler(DataModelMap& dataModelMap) : _dataModelMap(dataModelMap) {}

  virtual ~PricingDisplayContentHandler() = default;

  //--------------------------------------------------------------------------
  // @function PricingDisplayContentHandler::parse
  //
...
private:
  ...
  //--------------------------------------------------------------------------
  // @function PricingDisplayContentHandler::startElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function PricingDisplayContentHandler::endElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function PricingDisplayContentHandler::characters
  //
