...
class MileageContentHandler : public xercesc::DefaultHandler
{
public:
  explicit MileageContentHandler(DataModelMap& dataModelMap) : _dataModelMap(dataModelMap) {}

  virtual ~MileageContentHandler() = default;

  //--------------------------------------------------------------------------
  // @function MileageContentHandler::parse
  //
...
private:
  ...
  //--------------------------------------------------------------------------
  // @function MileageContentHandler::startElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function MileageContentHandler::endElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function MileageContentHandler::characters
  //
