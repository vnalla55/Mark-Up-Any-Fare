...
class TaxContentHandler : public xercesc::DefaultHandler
{
public:
  explicit TaxContentHandler(DataModelMap& dataModelMap) : _dataModelMap(dataModelMap) {}

  virtual ~TaxContentHandler() = default;

  //--------------------------------------------------------------------------
  // @function TaxContentHandler::parse
  //
...
protected:
  ...
  //--------------------------------------------------------------------------
  // @function TaxContentHandler::startElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function TaxContentHandler::endElement
  //
  ...
  //--------------------------------------------------------------------------
  // @function TaxContentHandler::characters
  //
...
private:
  std::string _text; // For collecting Element Data
};
} // end namespace tse
