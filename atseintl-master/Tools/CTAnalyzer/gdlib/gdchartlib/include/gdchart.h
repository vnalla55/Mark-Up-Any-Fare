...
EXTERND char				*GDC_title_font		DEFAULTO( nullptr );
EXTERND char				*GDC_ytitle_font	DEFAULTO( nullptr );
EXTERND char				*GDC_xtitle_font	DEFAULTO( nullptr );
EXTERND char				*GDC_yaxis_font		DEFAULTO( nullptr );
EXTERND char				*GDC_xaxis_font		DEFAULTO( nullptr );
...
#endif
EXTERND char				*GDC_ylabel_fmt		DEFAULTO( nullptr );		/* printf fmt'ing, e.g.: "%.2f" */
EXTERND char				*GDC_ylabel2_fmt	DEFAULTO( nullptr );		/* default: "%.0f" future: fractions */
EXTERND char				*GDC_xlabel_ctl		DEFAULTO( nullptr );		/* num_points[] TRUE,FALSE */
...
EXTERND GDC_ANNOTATION_T	*GDC_annotation		DEFAULTO( (GDC_ANNOTATION_T*)nullptr );
EXTERND enum GDC_font_size	GDC_annotation_font_size	DEFAULTO( GDC_SMALL );
#ifdef HAVE_LIBFREETYPE
EXTERND char				*GDC_annotation_font	DEFAULTO( nullptr );
EXTERND double				GDC_annotation_ptsize	DEFAULTO( 0.0 );
#endif
EXTERND int					GDC_num_scatter_pts	DEFAULTO( 0 );
EXTERND GDC_SCATTER_T		*GDC_scatter		DEFAULTO( (GDC_SCATTER_T*)nullptr );
...
EXTERND unsigned long		*GDC_ExtVolColor	DEFAULTO( (unsigned long*)nullptr );
							/* supercedes LineColor	ulong_color[num_sets] */
EXTERND unsigned long		*GDC_SetColor		DEFAULTO( (unsigned long*)nullptr );
							/* supercedes SetColor	ulong_color[num_sets][num_points] */
EXTERND unsigned long		*GDC_ExtColor		DEFAULTO( (unsigned long*)nullptr );
EXTERND char				GDC_transparent_bg	DEFAULTO( FALSE );
EXTERND char				*GDC_BGImage		DEFAULTO( (char*)nullptr );
