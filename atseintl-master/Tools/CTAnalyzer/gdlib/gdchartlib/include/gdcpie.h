...
EXTERND char				*GDCPIE_title			DEFAULTO( nullptr );		/* NLs ok here */
...
EXTERND char				*GDCPIE_title_font		DEFAULTO( nullptr );
EXTERND char				*GDCPIE_label_font		DEFAULTO( nullptr );
...
EXTERND int					*GDCPIE_explode			DEFAULTO( (int*)nullptr );	/* [num_points] */
															/* [num_points] supercedes GDCPIE_PlotColor */
EXTERND unsigned long		*GDCPIE_Color			DEFAULTO( (unsigned long*)nullptr );
EXTERND unsigned char		*GDCPIE_missing			DEFAULTO( (unsigned char*)nullptr );	/* TRUE/FALSE */
