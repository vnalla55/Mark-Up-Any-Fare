...
/usr/bin/tail -1 Transactions.log | /bin/mail -s "XML for core" mike.carroll@sabre.com
#/usr/bin/tail -1 Transactions.log | /bin/mail -s "XML for core" abu.islam@sabre.com
/bin/cat /dev/null > tserequest.log
/bin/cat /dev/null > tseserver.log
# run the tseserver.
#exec /opt/atseintl/bin/tseserver -c /opt/atseintl/faredisplay/tseserverLB.cfg > /dev/null 2>&1 
exec /opt/atseintl/bin/tseserver -c /opt/atseintl/faredisplay/tseserverLB.cfg > /dev/null 2>&1
