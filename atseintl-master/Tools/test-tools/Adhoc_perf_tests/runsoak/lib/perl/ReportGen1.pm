...
sub genHTML
{
    ...
    if($testType eq "adhoc") {
        print $htmlFH "<link rel=\"stylesheet\" href=\"../../../includes/css/v2.css\" type=\"text/css\">\n";
    }
    else {
        print $htmlFH "<link rel=\"stylesheet\" href=\"../../../../includes/css/v2.css\" type=\"text/css\">\n";
    }
...
sub genBusinessFunctionStats
{
    ...
    print $htmlFH "<tr>\n";
    print $htmlFH "<td>\n";
    print $htmlFH "<table id=listTable style=\"behavior:url(../includes/css/tablehl2.htc);\" slcolor='#BEC5DE' hlcolor='#BEC5DE' cellspacing=\"1\" cellpadding=\"0\" width=\"100%\" bgcolor=\"gray\" border=\"0\">\n";
    print $htmlFH "<THEAD>\n";
