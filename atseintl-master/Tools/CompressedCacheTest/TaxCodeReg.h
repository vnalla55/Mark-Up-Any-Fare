...
// Updates:
//
// Copyright 2004, Sabre Inc.  All rights reserved.  This software/documentation is
...
#include "TaxCodeText.h"
#include "TaxCodeCabin.h"
#include "TaxRestrictionTktDesignator.h"
...
protected:
    ...
    std::string toString(unsigned int amount, unsigned int noDec)
    {
      ...
      {
        return zeroStripper("0." +
                            std::string(noDec - amountStr.size(), '0') +
                            amountStr);
      }
    }
...
// DateTime _modDate;  Dates init themselves
    ...
    ~TaxCodeReg()
    { // Nuke the Kids!
        std::vector<TaxCodeText *> ::iterator textIt;
        for (textIt = _taxCodeTexts.begin();textIt != _taxCodeTexts.end();textIt++)
        {
            delete *textIt;
        }
    ...
    friend std::ostream& operator << (std::ostream& os,
                                      const AmtInt& amtInt)
    {
      return os << '{' << amtInt.nodec() << '|' << amtInt.amt() << '}';
    }
    ...
    const std::vector<CarrierCode>& restrictionValidationCxr() const { return _restrictionValidationCxr; }
    ...
    const std::vector<TaxRestrictionTransit>& restrictionTransit() const { return _restrictionTransit; }
    ...
    const std::vector<TaxRestrictionTktDesignator *>& taxRestrTktDsgs() const { return _taxRestrTktDsgs; }
    ...
    {
      bool eq(    ( _taxCode                  == rhs._taxCode                  )
               && ( _versionDate              == rhs._versionDate              )
               && ( _seqNo                    == rhs._seqNo                    )
               && ( _createDate               == rhs._createDate               )
               && ( _expireDate               == rhs._expireDate               )
               && ( _lockDate                 == rhs._lockDate                 )
               && ( _specialProcessNo         == rhs._specialProcessNo         )
               && ( _taxNodec                 == rhs._taxNodec                 )
               && ( _taxcdRoundUnitNodec      == rhs._taxcdRoundUnitNodec      )
               && ( _fareRangeNodec           == rhs._fareRangeNodec           )
               && ( _discPercentNodec         == rhs._discPercentNodec         )
               && ( _discPercent              == rhs._discPercent              )
               && ( _taxAmt                   == rhs._taxAmt                   )
               && ( _minTax                   == rhs._minTax                   )
               && ( _maxTax                   == rhs._maxTax                   )
               && ( _plusupAmt                == rhs._plusupAmt                )
               && ( _lowRange                 == rhs._lowRange                 )
               && ( _highRange                == rhs._highRange                )
               && ( _rangeincrement           == rhs._rangeincrement           )
               && ( _taxcdRoundUnit           == rhs._taxcdRoundUnit           )
               && ( _effDate                  == rhs._effDate                  )
               && ( _discDate                 == rhs._discDate                 )
               && ( _firstTvlDate             == rhs._firstTvlDate             )
               && ( _lastTvlDate              == rhs._lastTvlDate              )
               && ( _modDate                  == rhs._modDate                  )
               && ( _loc1ExclInd              == rhs._loc1ExclInd              )
               && ( _loc1Type                 == rhs._loc1Type                 )
               && ( _loc1                     == rhs._loc1                     )
               && ( _loc2ExclInd              == rhs._loc2ExclInd              )
               && ( _loc2Type                 == rhs._loc2Type                 )
               && ( _loc2                     == rhs._loc2                     )
               && ( _taxType                  == rhs._taxType                  )
               && ( _nation                   == rhs._nation                   )
               && ( _taxcdRoundRule           == rhs._taxcdRoundRule           )
               && ( _taxfullFareInd           == rhs._taxfullFareInd           )
               && ( _taxequivAmtInd           == rhs._taxequivAmtInd           )
               && ( _taxexcessbagInd          == rhs._taxexcessbagInd          )
               && ( _tvlDateasoriginInd       == rhs._tvlDateasoriginInd       )
               && ( _displayonlyInd           == rhs._displayonlyInd           )
               && ( _feeInd                   == rhs._feeInd                   )
               && ( _interlinableTaxInd       == rhs._interlinableTaxInd       )
               && ( _showseparateInd          == rhs._showseparateInd          )
               && ( _posExclInd               == rhs._posExclInd               )
               && ( _posLocType               == rhs._posLocType               )
               && ( _posLoc                   == rhs._posLoc                   )
               && ( _poiExclInd               == rhs._poiExclInd               )
               && ( _poiLocType               == rhs._poiLocType               )
               && ( _poiLoc                   == rhs._poiLoc                   )
               && ( _sellCurExclInd           == rhs._sellCurExclInd           )
               && ( _sellCur                  == rhs._sellCur                  )
               && ( _occurrence               == rhs._occurrence               )
               && ( _freeTktexempt            == rhs._freeTktexempt            )
               && ( _idTvlexempt              == rhs._idTvlexempt              )
               && ( _rangeType                == rhs._rangeType                )
               && ( _rangeInd                 == rhs._rangeInd                 )
               && ( _nextstopoverrestr        == rhs._nextstopoverrestr        )
               && ( _spclTaxRounding          == rhs._spclTaxRounding          )
               && ( _taxCur                   == rhs._taxCur                   )
               && ( _taxCurNodec              == rhs._taxCurNodec              )
               && ( _fareclassExclInd         == rhs._fareclassExclInd         )
               && ( _tktdsgExclInd            == rhs._tktdsgExclInd            )
               && ( _valcxrExclInd            == rhs._valcxrExclInd            )
               && ( _exempequipExclInd        == rhs._exempequipExclInd        )
               && ( _psgrExclInd              == rhs._psgrExclInd              )
               && ( _exempcxrExclInd          == rhs._exempcxrExclInd          )
               && ( _fareTypeExclInd          == rhs._fareTypeExclInd          )
               && ( _multioccconvrndInd       == rhs._multioccconvrndInd       )
               && ( _originLocType            == rhs._originLocType            )
               && ( _originLoc                == rhs._originLoc                )
               && ( _originLocExclInd         == rhs._originLocExclInd         )
               && ( _versioninheritedInd      == rhs._versioninheritedInd      )
               && ( _versiondisplayInd        == rhs._versiondisplayInd        )
               && ( _loc1Appl                 == rhs._loc1Appl                 )
               && ( _loc2Appl                 == rhs._loc2Appl                 )
               && ( _tripType                 == rhs._tripType                 )
               && ( _travelType               == rhs._travelType               )
               && ( _itineraryType            == rhs._itineraryType            )
               && ( _formOfPayment            == rhs._formOfPayment            )
               && ( _taxOnTaxExcl             == rhs._taxOnTaxExcl             )
               && ( _feeApplInd               == rhs._feeApplInd               )
               && ( _bookingCode1             == rhs._bookingCode1             )
               && ( _bookingCode2             == rhs._bookingCode2             )
               && ( _bookingCode3             == rhs._bookingCode3             )
               ...
               && ( _equipmentCode            == rhs._equipmentCode            )
               && ( _exemptionCxr             == rhs._exemptionCxr             )
               && ( _taxOnTaxCode             == rhs._taxOnTaxCode             )
               && ( _restrictionTransit       == rhs._restrictionTransit       )
               && ( _taxCodeTexts.size()      == rhs._taxCodeTexts.size()      )
               && ( _cabins.size()            == rhs._cabins.size()            )
               && ( _taxRestrTktDsgs.size()   == rhs._taxRestrTktDsgs.size()   )
               && ( _taxAmtInt                == rhs._taxAmtInt                )
               && ( _minTaxInt                == rhs._minTaxInt                )
               && ( _maxTaxInt                == rhs._maxTaxInt                )
               && ( _taxcdRoundUnitInt        == rhs._taxcdRoundUnitInt        )
               && ( _lowRangeInt              == rhs._lowRangeInt              )
               && ( _highRangeInt             == rhs._highRangeInt             )
               && ( _discPercentInt           == rhs._discPercentInt           )
               && ( _taxRestrictionLocNo      == rhs._taxRestrictionLocNo      )
               && ( _specConfigName           == rhs._specConfigName           )
             ) ;

      for( size_t i = 0 ; ( eq && ( i < _taxCodeTexts.size() ) ) ; ++i )
      {
        eq = ( *(_taxCodeTexts[i]) == *(rhs._taxCodeTexts[i]) ) ;
      }
    ...
    static void dummyData( TaxCodeReg & obj )
    {
      ...
      obj._versionDate              = 1            ;
      obj._seqNo                    = 2            ;
      obj._createDate               = time( NULL ) ;
      obj._expireDate               = time( NULL ) ;
      obj._lockDate                 = time( NULL ) ;
      ...
      obj._effDate                  = time( NULL ) ;
      obj._discDate                 = time( NULL ) ;
      obj._firstTvlDate             = time( NULL ) ;
      obj._lastTvlDate              = time( NULL ) ;
      obj._modDate                  = time( NULL ) ;
      obj._loc1ExclInd              = 'D'          ;
      ...
      TaxCodeText * tct1 = new TaxCodeText ;
      TaxCodeText * tct2 = new TaxCodeText ;

      TaxCodeText::dummyData( *tct1 ) ;
      TaxCodeText::dummyData( *tct2 ) ;

      obj._taxCodeTexts.push_back( tct1 ) ;
      obj._taxCodeTexts.push_back( tct2 ) ;
...
protected:
    ...
    std::vector<TaxCodeText *>                 _taxCodeTexts             ;
...
public:
    ...
    void flattenize( Flattenizable::Archive & archive )
    {
      ...
      FLATTENIZE( archive, _taxCodeTexts             ) ;
...
protected:
                                                        ...
                                                        T ptr)
    {
      return buffer
             ...
             & ptr->_expireDate
             & ptr->_lockDate
             & ptr->_specialProcessNo
             & ptr->_taxNodec
             & ptr->_taxcdRoundUnitNodec
             & ptr->_fareRangeNodec
             ...
             & ptr->_taxfullFareInd
             & ptr->_taxequivAmtInd
             & ptr->_taxexcessbagInd
             & ptr->_tvlDateasoriginInd
             & ptr->_displayonlyInd
             & ptr->_feeInd
             & ptr->_interlinableTaxInd
             & ptr->_showseparateInd
             & ptr->_posExclInd
             & ptr->_posLocType
             & ptr->_posLoc
             & ptr->_poiExclInd
             ...
             & ptr->_rangeType
             & ptr->_rangeInd
             & ptr->_nextstopoverrestr
             & ptr->_spclTaxRounding
             & ptr->_taxCur
             & ptr->_taxCurNodec
             & ptr->_fareclassExclInd
             & ptr->_tktdsgExclInd
             & ptr->_valcxrExclInd
             & ptr->_exempequipExclInd
             & ptr->_psgrExclInd
             & ptr->_exempcxrExclInd
             & ptr->_fareTypeExclInd
             & ptr->_multioccconvrndInd
             & ptr->_originLocType
             & ptr->_originLoc
             & ptr->_originLocExclInd
             ...
             & ptr->_bookingCode2
             & ptr->_bookingCode3
             & ptr->_restrictionValidationCxr
             & ptr->_restrictionPsg
             & ptr->_restrictionFareType
             & ptr->_restrictionFareClass
             & ptr->_equipmentCode
             & ptr->_exemptionCxr
             & ptr->_taxOnTaxCode
             & ptr->_restrictionTransit
             & ptr->_taxCodeTexts
             & ptr->_cabins
             & ptr->_taxRestrTktDsgs
             & ptr->_taxAmtInt
             & ptr->_minTaxInt
             & ptr->_maxTaxInt
             & ptr->_taxcdRoundUnitInt
             & ptr->_lowRangeInt
             & ptr->_highRangeInt
             & ptr->_discPercentInt
             & ptr->_taxRestrictionLocNo
             & ptr->_specConfigName;
    }
