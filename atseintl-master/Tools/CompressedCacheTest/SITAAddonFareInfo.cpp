...
AddonFareInfo* SITAAddonFareInfo::clone( DataHandle& dataHandle ) const
{
  SITAAddonFareInfo* cloneObj = 0;


  return cloneObj;
}

void SITAAddonFareInfo::clone( AddonFareInfo& cloneObj ) const
{
  SITAAddonFareInfo& afClone  = static_cast<SITAAddonFareInfo&>( cloneObj );
