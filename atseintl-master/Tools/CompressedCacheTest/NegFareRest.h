...
public:
      ...
      NegFareRest ()
      : _unavailTag(' ')
      , _negFareSecurityTblItemNo(0)
      , _negFareCalcTblItemNo(0)
      , _fareAmt1(0)
      , _fareAmt2(0)
      , _commAmt1(0)
      , _commAmt2(0)
    ...
    boost::container::string &bagNo() { return _bagNo;}
    const boost::container::string &bagNo() const { return _bagNo; }
    ...
    boost::container::string &tourBoxCode1() { return _tourBoxCode1;}
    const boost::container::string &tourBoxCode1() const { return _tourBoxCode1; }
    ...
    boost::container::string &fareBoxText1() { return _fareBoxText1;}
    const boost::container::string &fareBoxText1() const { return _fareBoxText1; }
    ...
    boost::container::string &tourBoxCode2() { return _tourBoxCode2;}
    const boost::container::string &tourBoxCode2() const { return _tourBoxCode2; }
    ...
    boost::container::string &fareBoxText2() { return _fareBoxText2;}
    const boost::container::string &fareBoxText2() const { return _fareBoxText2; }
    ...
    {
      return(    (  RuleItemInfo::operator   ==( rhs )                        )
              ...
              && ( _negFareCalcTblItemNo     == rhs._negFareCalcTblItemNo     )
              && ( _fareAmt1                 == rhs._fareAmt1                 )
              && ( _fareAmt2                 == rhs._fareAmt2                 )
              && ( _commAmt1                 == rhs._commAmt1                 )
              && ( _commAmt2                 == rhs._commAmt2                 )
              && ( _commPercent              == rhs._commPercent              )
              && ( _commPercentNoDec         == rhs._commPercentNoDec         )
              && ( _noDec1                   == rhs._noDec1                   )
              && ( _noDec2                   == rhs._noDec2                   )
              && ( _noSegs                   == rhs._noSegs                   )
              && ( _noDec11                  == rhs._noDec11                  )
              && ( _ruleTariff1              == rhs._ruleTariff1              )
              && ( _noDec21                  == rhs._noDec21                  )
              && ( _ruleTariff2              == rhs._ruleTariff2              )
              && ( _netRemitMethod           == rhs._netRemitMethod           )
              && ( _netGrossInd              == rhs._netGrossInd              )
              && ( _upgradeInd               == rhs._upgradeInd               )
              && ( _bagTypeInd               == rhs._bagTypeInd               )
              && ( _validationInd            == rhs._validationInd            )
              && ( _tktAppl                  == rhs._tktAppl                  )
              && ( _psgType                  == rhs._psgType                  )
              && ( _cur1                     == rhs._cur1                     )
              && ( _cur2                     == rhs._cur2                     )
              && ( _bagNo                    == rhs._bagNo                    )
              && ( _carrier                  == rhs._carrier                  )
              && ( _couponInd1               == rhs._couponInd1               )
              && ( _tourBoxCodeType1         == rhs._tourBoxCodeType1         )
              && ( _tktFareDataInd1          == rhs._tktFareDataInd1          )
              && ( _owrt1                    == rhs._owrt1                    )
              && ( _seasonType1              == rhs._seasonType1              )
              && ( _dowType1                 == rhs._dowType1                 )
              && ( _tourBoxCode1             == rhs._tourBoxCode1             )
              && ( _tktDesignator1           == rhs._tktDesignator1           )
              && ( _globalDir1               == rhs._globalDir1               )
              && ( _carrier11                == rhs._carrier11                )
              && ( _rule1                    == rhs._rule1                    )
              && ( _fareClass1               == rhs._fareClass1               )
              && ( _fareType1                == rhs._fareType1                )
              && ( _betwCity1                == rhs._betwCity1                )
              && ( _andCity1                 == rhs._andCity1                 )
              && ( _fareBoxText1             == rhs._fareBoxText1             )
              && ( _cur11                    == rhs._cur11                    )
              && ( _couponInd2               == rhs._couponInd2               )
              && ( _tourBoxCodeType2         == rhs._tourBoxCodeType2         )
              && ( _tktFareDataInd2          == rhs._tktFareDataInd2          )
              && ( _owrt2                    == rhs._owrt2                    )
              && ( _seasonType2              == rhs._seasonType2              )
              && ( _dowType2                 == rhs._dowType2                 )
              && ( _tourBoxCode2             == rhs._tourBoxCode2             )
              && ( _tktDesignator2           == rhs._tktDesignator2           )
              && ( _globalDir2               == rhs._globalDir2               )
              && ( _carrier21                == rhs._carrier21                )
              && ( _rule2                    == rhs._rule2                    )
              && ( _fareClass2               == rhs._fareClass2               )
              && ( _fareType2                == rhs._fareType2                )
              && ( _betwCity2                == rhs._betwCity2                )
              && ( _andCity2                 == rhs._andCity2                 )
              && ( _fareBoxText2             == rhs._fareBoxText2             )
              && ( _cur21                    == rhs._cur21                    )
    ...
    void dummyData()
    {
      ...
      RuleItemInfo::dummyData(*this) ;

      _createDate               = currentTime ;
      _expireDate               = currentTime ;
      _unavailTag               = 'A'          ;
      _negFareSecurityTblItemNo = 1            ;
      _negFareCalcTblItemNo     = 2            ;
      _fareAmt1                 = 3.33         ;
      _fareAmt2                 = 4.44         ;
      _commAmt1                 = 5.55         ;
      _commAmt2                 = 6.66         ;
      ...
      _seasonType1              = 'X'          ;
      _dowType1                 = 'Y'          ;
      _tourBoxCode1             = "bbbbbbbb"   ;
      _tktDesignator1           = "abcdefghij" ;
      _globalDir1               = US           ;
      _carrier11                = "klm"        ;
      _rule1                    = "nopq"       ;
      _fareClass1               = "rstuvwxy"   ;
      _fareType1                = "z1234567"   ;
      _betwCity1                = "890ABCDE"   ;
      _andCity1                 = "FGHIJKLM"   ;
      _fareBoxText1             = "cccccccc"   ;
      _cur11                    = "NOP"        ;
      _couponInd2               = 'R'          ;
      _tourBoxCodeType2         = 'S'          ;
      _tktFareDataInd2          = 'T'          ;
      ...
      _seasonType2              = 'V'          ;
      _dowType2                 = 'W'          ;
      _tourBoxCode2             = "dddddddd"   ;
      _tktDesignator2           = "XYZabcdefg" ;
      _globalDir2               = US           ;
      _carrier21                = "hij"        ;
      _rule2                    = "klmn"       ;
      _fareClass2               = "opqrstuv"   ;
      _fareType2                = "wxyz1234"   ;
      _betwCity2                = "567890AB"   ;
      _andCity2                 = "CDEFGHIJ"   ;
      _fareBoxText2             = "eeeeeeee"   ;
      _cur21                    = "KLM"        ;
      _inhibit                  = 'N'          ;
    }
...
protected:
    ...
    int             _negFareSecurityTblItemNo ;
    int             _negFareCalcTblItemNo     ;
    MoneyAmount     _fareAmt1                 ;
    MoneyAmount     _fareAmt2                 ;
    MoneyAmount     _commAmt1                 ;
    MoneyAmount     _commAmt2                 ;
    Percent         _commPercent              ;
    int             _commPercentNoDec         ;
    int             _noDec1                   ;
    int             _noDec2                   ;
    int             _noSegs                   ;
    int             _noDec11                  ;
    TariffNumber    _ruleTariff1              ;
    int             _noDec21                  ;
    TariffNumber    _ruleTariff2              ;
    ...
    Indicator       _dowType1                 ;
    boost::container::string     _tourBoxCode1;
    TktDesignator   _tktDesignator1           ;
    GlobalDirection _globalDir1               ;
    ...
    LocCode         _betwCity1                ;
    LocCode         _andCity1                 ;
    boost::container::string _fareBoxText1    ;
    CurrencyCode    _cur11                    ;
    ...
    Indicator       _dowType2                 ;
    boost::container::string     _tourBoxCode2;
    TktDesignator   _tktDesignator2           ;
    GlobalDirection _globalDir2               ;
    ...
    LocCode         _betwCity2                ;
    LocCode         _andCity2                 ;
    boost::container::string    _fareBoxText2 ;
    CurrencyCode    _cur21                    ;
    Indicator       _inhibit                  ;
  ...
  private:
                                                         ...
                                                         T ptr)
    {
      ...
      return buffer
             ...
             & ptr->_expireDate
             & ptr->_unavailTag
             & ptr->_negFareSecurityTblItemNo
             & ptr->_negFareCalcTblItemNo
             & ptr->_fareAmt1
             & ptr->_fareAmt2
             & ptr->_commAmt1
             & ptr->_commAmt2
             & ptr->_commPercent
             & ptr->_commPercentNoDec
             & ptr->_noDec1
             & ptr->_noDec2
             & ptr->_noSegs
             & ptr->_noDec11
             ...
             & ptr->_carrier
             & ptr->_couponInd1
             & ptr->_tourBoxCodeType1
             & ptr->_tktFareDataInd1
             & ptr->_owrt1
             & ptr->_seasonType1
             & ptr->_dowType1
             & ptr->_tourBoxCode1
             ...
             & ptr->_cur11
             & ptr->_couponInd2
             & ptr->_tourBoxCodeType2
             & ptr->_tktFareDataInd2
             & ptr->_owrt2
             & ptr->_seasonType2
             & ptr->_dowType2
             & ptr->_tourBoxCode2
